...
// ------------------------------------------------------------------------------
bool
bprimeKit::IsSelectedMuon( const MuonIterator& mu ) const
{
...
TLorentzVector
bprimeKit::CleanAK4Jet( JetIterator jet )
{
...
TLorentzVector
bprimeKit::CleanAK8Jet( JetIterator fatjet )
{
...
bool
HasOverLap( const MuonIterator& muon, const JetConstituent& jet_const )
{
