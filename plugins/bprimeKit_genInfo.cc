...
// ------------------------------------------------------------------------------
bool
bprimeKit::FillfGenInfo( const edm::Event& iEvent, const edm::EventSetup& iSetup )
{
   // --------------------------------------------------------------------------
   ...
   // --------------------------------------------------------------------------
   if( quarkID.size() == 0 ){ return 0; } else if( quarkID.size() != 2 ){
   ...
   // 2 t quarks, check for Z's and H's
      ...
      if( bosonID[0] == 23 && bosonID[1] == 23 ){isTZTZ = true; } else if( bosonID[0] == 25 && bosonID[1] == 25 ){
         isTHTH = true;
   ...
   // t-b pairs, check for correlating bosons in the right spots
      ...
      if( bosonID[0] == 23 && abs( bosonID[1] ) == 24 ){isTZBW = true; } else if( bosonID[0] == 25 && abs( bosonID[1] ) == 24 ){
         isTHBW = true;
   ...
   // b-t pairs, check for correlating bosons in the right spots
      ...
      if( bosonID[1] == 23 && abs( bosonID[0] ) == 24 ){isTZBW = true; } else if( bosonID[1] == 25 && abs( bosonID[0] ) == 24 ){
         isTHBW = true;
...
int
bprimeKit::PhotonFlag( const GenIterator& particle ) const
{
...
bool
bprimeKit::HasTprimeDaughter( const GenIterator& particle ) const
{
