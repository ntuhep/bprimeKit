...
bprimeKit = cms.EDAnalyzer(
      ...
      JetSettings = cms.VPSet(
         ...
         cms.PSet(
            jetCollection = cms.string( 'TopJetInfo_JetToolBox' ),
            jetLabel      = cms.InputTag( 'selectedPatJetsAK8PFCHS' ),
            subjetLabel   = cms.InputTag( 'patJetsCMSTopTagCHSPacked' ),
            ),
         cms.PSet(
            jetCollection = cms.string( 'TopJetInfo_MiniAOD'),
            jetLabel      = cms.InputTag( 'slimmedJetsAK8' ),
            subjetLabel   = cms.InputTag( 'slimmedJetsCMSTopTagCHSPacked' , "SubJets"),
