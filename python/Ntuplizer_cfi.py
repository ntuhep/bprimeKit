...
photonbase = cms.PSet(
    ...
    rhosrc     = rhosrc,
    phoLooseIdMap  = cms.InputTag('egmPhotonIDs:cutBasedPhotonID-Fall17-94X-V1-Preliminary-loose'),
    phoMediumIdMap = cms.InputTag('egmPhotonIDs:cutBasedPhotonID-Fall17-94X-V1-Preliminary-medium'),
    phoTightIdMap  = cms.InputTag('egmPhotonIDs:cutBasedPhotonID-Fall17-94X-V1-Preliminary-tight'),
