...
process.bprimeKit = cms.EDAnalyzer(
  ...
  muonlabel = cms.VInputTag('selectedPatMuons'+postfix,'cleanPatMuons'),
  eleclabel = cms.VInputTag('selectedPatElectrons'+postfix,'cleanPatElectrons'),
