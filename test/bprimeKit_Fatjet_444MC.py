...
if not options.useData :
  ...
  elif options.release == '44x' :
    process.source.fileNames = [
       'file:/raid1/w/kfjack/temp/60E21D27-5F40-E111-8860-003048678AC0.root'
       ]
  ...
  if options.release == '42x':
    ...
    process.source.fileNames = [
        'file:./0E2F34EF-5B83-E111-8126-BCAEC518FF8D.root'
...
process.bprimeKit = cms.EDAnalyzer(
  ...
  muonlabel = cms.VInputTag('selectedPatMuonsLoose'+postfix,'selectedPatMuons'),
  eleclabel = cms.VInputTag('selectedPatElectronsLoose'+postfix,'selectedPatElectrons'),
  taulabel = cms.VInputTag('selectedPatTaus'+postfix),
  LepCollections = cms.vstring('PFLepInfo','LepInfo'),
  jetlabel= cms.VInputTag('selectedPatJets'+postfix,'goodPatJetsCA8PrunedPF','selectedPatJets'),
  JetCollections = cms.vstring('PFJetInfo','WJetInfo','JetInfo'),
  JetType = cms.vint32(0,2,1),
