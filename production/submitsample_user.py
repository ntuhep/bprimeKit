...
config.General.requestName = 'BPK_124X_{0}'
...
def submitsample(argv):
    ...
    parser.add_option('-l','--lfndir',dest='lfndir',help='the storage lfn directory' , default='/store/user/' + os.environ.get('USER') + '/BprimeKit_Ntuples_CMSSW_124X', type='string')
