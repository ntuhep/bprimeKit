...
public:
  ...
  RegisterTree( TTree* root, const std::string& name = "EvtInfo" )
  {
    ...
    root->Branch( ( name+".Flag_globalSuperTightHalo2016Filter" ).c_str(),       &Flag_globalSuperTightHalo2016Filter,       ( name+"Flag_globalSuperTightHalo2016Filter/O" ).c_str() );
    root->Branch( ( name+".Flag_BadPFMuonFilter" ).c_str(),                      &Flag_BadPFMuonFilter,                      ( name+"Flag_BadPFMuonFilter/O" ).c_str() );
    root->Branch( ( name+".Flag_BadChargedCandidateFilter" ).c_str(),            &Flag_BadChargedCandidateFilter,            ( name+"Flag_BadChargedCandidateFilter/O" ).c_str() );
  ...
  Register( TTree* root, const std::string& name = "EvtInfo" )
  {
    ...
    root->SetBranchAddress( ( name+".Flag_globalSuperTightHalo2016Filter" ).c_str(),       &Flag_globalSuperTightHalo2016Filter );
    root->SetBranchAddress( ( name+".Flag_BadPFMuonFilter" ).c_str(),                      &Flag_BadPFMuonFilter );
    root->SetBranchAddress( ( name+".Flag_BadChargedCandidateFilter" ).c_str(),            &Flag_BadChargedCandidateFilter );
