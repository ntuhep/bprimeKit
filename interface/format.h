...
public:
  ...
  RegisterTree( TTree* root, const std::string& name = "JetInfo" )
  {
    ...
    root->Branch( ( name+".ParT_BvsAll" ).c_str(),                                  ParT_BvsAll,                                  ( name+".ParT_BvsAll["+name+".Size]/F" ).c_str() );
  ...
  Register( TTree* root, const std::string& name = "JetInfo" )
  {
    ...
    root->SetBranchAddress( ( name+".ParT_BvsAll" ).c_str(),                                  ParT_BvsAll );
