...
public:
  ...
  Bool_t Flag_EcalDeadCell;
  Bool_t Flag_goodVertices;
  Bool_t Flag_eeBadScFilter;
  Bool_t Flag_globalTightHalo2016Filter;
  Bool_t Flag_badMuon;
  Bool_t Flag_badChargedhadron;
  ...
  RegisterTree( TTree* root, const std::string& name = "EvtInfo" )
  {
    ...
    root->Branch( ( name+".Flag_HBHENoiseFilter" ).c_str(),                      &Flag_HBHENoiseFilter,                      ( name+"Flag_HBHENoiseFilter/O" ).c_str() );
    root->Branch( ( name+".Flag_HBHENoiseIsoFilter" ).c_str(),                   &Flag_HBHENoiseIsoFilter,                   ( name+"Flag_HBHENoiseIsoFilter/O" ).c_str() );
    root->Branch( ( name+".Flag_EcalDeadCell" ).c_str(),                         &Flag_EcalDeadCell,                         ( name+"Flag_EcalDeadCell/O" ).c_str() );
    root->Branch( ( name+".Flag_goodVertices" ).c_str(),                         &Flag_goodVertices,                         ( name+"Flag_goodVertices/O" ).c_str() );
    root->Branch( ( name+".Flag_eeBadScFilter" ).c_str(),                        &Flag_eeBadScFilter,                        ( name+"Flag_eeBadScFilter/O" ).c_str() );
    root->Branch( ( name+".Flag_globalTightHalo2016Filter" ).c_str(),            &Flag_globalTightHalo2016Filter,            ( name+"Flag_globalTightHalo2016Filter/O" ).c_str() );
    root->Branch( ( name+".Flag_badMuon" ).c_str(),                              &Flag_badMuon,                              ( name+"Flag_badMuon/O" ).c_str() );
    root->Branch( ( name+".Flag_badChargedhadron" ).c_str(),                     &Flag_badChargedhadron,                     ( name+"Flag_badChargedhadron/O" ).c_str() );
  ...
  Register( TTree* root, const std::string& name = "EvtInfo" )
  {
    ...
    root->SetBranchAddress( ( name+".Flag_HBHENoiseFilter" ).c_str(),                      &Flag_HBHENoiseFilter );
    root->SetBranchAddress( ( name+".Flag_HBHENoiseIsoFilter" ).c_str(),                   &Flag_HBHENoiseIsoFilter );
    root->SetBranchAddress( ( name+".Flag_EcalDeadCell" ).c_str(),                         &Flag_EcalDeadCell );
    root->SetBranchAddress( ( name+".Flag_goodVertices" ).c_str(),                         &Flag_goodVertices );
    root->SetBranchAddress( ( name+".Flag_eeBadScFilter" ).c_str(),                        &Flag_eeBadScFilter );
    root->SetBranchAddress( ( name+".Flag_globalTightHalo2016Filter" ).c_str(),            &Flag_globalTightHalo2016Filter );
    root->SetBranchAddress( ( name+".Flag_badMuon" ).c_str(),                              &Flag_badMuon );
    root->SetBranchAddress( ( name+".Flag_badChargedhadron" ).c_str(),                     &Flag_badChargedhadron );
